# Home
Welcome to the YoshiCrafter Engine documentation.

## Basic Modding
- [Enabling Developer Mode](basic/enabledevmode.md)
- [Make a mod](basic/makeamod.md)
- [Toolbox Basics](basic/toolbox.md)
...
- [`data/titlescreen.hx`](assets/data/titlescreen.md)
- [`shader/shader.frag`](assets/shaders/shader.frag.md)
- [`ui/MainMenuState.hx`](assets/ui/MainMenuState.hx.md)
- [`ui/FreeplayState.hx`](assets/ui/FreeplayState.hx.md)
- [`config.json`](assets/config.md)
- [`medals.json`](assets/medals.md)
